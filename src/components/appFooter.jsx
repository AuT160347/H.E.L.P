      ...
      <Row className="mb-4">
        ...
        <Col md={3} className="mb-4">
          ...
          <ul className="list-unstyled small">
            ...
            <li><Link to={'date'} className="text-light text-decoration-none">{text[language].date}</Link></li>
        ...
        <Col md={3} className="mb-4">
          ...
          <ul className="list-unstyled small">
            <li><GeoAltFill className="me-2" /> มหาวิทยาลัยสุขภาพแห่งชาติ</li>
            <li><TelephoneFill className="me-2" /> 02-123-4567</li>
            <li><EnvelopeFill className="me-2" /> support@helphealth.com</li>
          </ul>
        </Col>
