...
const Home = () => {
    ...
    useEffect(() => {
        const loadDoctors = async () => {
            ...
            const filtered = data.filter((doc) => recommendedIds.includes(doc.id));
            setDoctors(filtered);
            setLoading(false);
        };
        loadDoctors();
    ...
    return (
        <div>
            ...
            >
                <Row className="w-100" style={{ marginTop: "76px", marginLeft: "-150px" }}>
                    <Col xs={10} sm={8} md={6} lg={5}>
                        ...
                        >
                            <div style={{ width: "450px", marginLeft: "90px", marginTop: "25px" }}>
            ...
            <Container fluid className="py-5 px-4 bg-light">
                ...
                <div
                    className="doctor-slider d-flex overflow-x-auto gap-3 px-2"
                    style={{
                        scrollbarWidth: "thin",
                ...
                >
                    {doctors.map((doc) => (
                        <div
                            key={doc.id}
                            className="doctor-card text-center shadow-sm rounded-4 p-2 flex-shrink-0"
                            style={{
                                minWidth: "200px",
                                maxWidth: "200px",
                                minHeight: "210px",
